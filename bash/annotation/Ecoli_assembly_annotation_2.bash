...
FAIL_LOG="${WORK_PATH}/Ecoli_assembly_annotation_2.failed_skipped.log"
exec > >(tee -a "${LOG}") 2>&1
...
for sample_id in "${sample_ids[@]}"; do
    ...
    fastqc_raw_out="${PREPROCESSING_ECOLI}/fastqc_Ecoli_raw/${sample_id}_L3_1_fastqc.html"
...
for sample_id in "${sample_ids[@]}"; do
    ...
    echo ""
    echo -e "\e[32m ================================================================ \e[0m"
    echo -e "\e[32m E. COLI ASSEMBLY & ANNOTATION (BATCH 2) COMPLETE â€” $(date)       \e[0m"
    echo -e "\e[32m ================================================================ \e[0m"
    echo ""
