...
FAIL_LOG="${WORK_PATH}/Kleb_assembly_annotation_3.failed_skipped.log"
exec > >(tee -a "${LOG}") 2>&1
...
for sample_id in "${sample_ids[@]}"; do
    ...
    fastqc_raw_out="${PREPROCESSING_KLEB}/fastqc_Kleb_raw/${sample_id}_R1_fastqc.html"
...
for sample_id in "${sample_ids[@]}"; do
    ...
    echo ""
    echo -e "\e[32m ================================================================ \e[0m"
    echo -e "\e[32m K. PNEUMONIAE ASSEMBLY & ANNOTATION (BATCH 3) COMPLETE â€” $(date) \e[0m"
    echo -e "\e[32m ================================================================ \e[0m"
    echo ""
